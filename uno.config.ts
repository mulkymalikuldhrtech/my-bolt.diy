  ...
  presets: [
    ...
    presetIcons({
      ...
      collections: {
        ...
        si: () => import('@iconify-json/si/icons.json').then(i => i.default as IconifyJSON),
        'svg-spinners': () => import('@iconify-json/svg-spinners/icons.json').then(i => i.default as IconifyJSON),
      },
      unit: 'em',
    }),
  ],
